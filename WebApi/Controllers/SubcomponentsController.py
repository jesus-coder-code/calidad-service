...
@router.post(
    "/subcomponents/CreateSubcomponent", response_model=SubcomponentSchemaResponse
)
...
@router.put("/subcomponents/UpdateSubcomponent/{subcomponent_id}")
...
@router.delete("/subcomponents/DeleteSubcomponent/{subcomponent_id}")
